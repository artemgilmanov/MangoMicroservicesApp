    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> GetCart(string userId)
        {
            try
            {
                ...
                cart.CartDetails = _mapper.Map<IEnumerable<CartDetailsDto>>(_db.CartDetail
        ...
        public async Task<ResponseDto> CartUpsert(CartDto cartDto)
        {
            try
            {
                ...
                else
                {
                    ...
                    var cartDetailsFromDb = await _db.CartDetail.AsNoTracking().FirstOrDefaultAsync(
        ...
        public async Task<ResponseDto> CartRemove([FromBody] int cartDetailsId)
        {
            try
            {
                CartDetails cartDetails = _db.CartDetail
